    ...
    >
      ...
      >
        ...
        <div className="mt-6 flex justify-center gap-3">
          <button
            onClick={onCancel}
            className="rounded-lg border border-slate-300 px-6 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50 transition-colors"
          >
            {cancelText || t("common.cancel")}
          </button>
          <button
            onClick={onConfirm}
            className={`rounded-lg ${confirmButtonStyles[type]} px-6 py-2 text-sm font-semibold text-white shadow transition-colors`}
          >
